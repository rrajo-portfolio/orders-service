...
public class OrderPage {
  ...
  @Valid
  private List<@Valid Order> content = new ArrayList<>();
   ...
   */
  public OrderPage(List<@Valid Order> content, Integer page, Integer size, Long totalElements, Integer totalPages) {
  ...
  public OrderPage content(List<@Valid Order> content) {
    this.content = content;
    return this;
  }

  public OrderPage addContentItem(Order contentItem) {
  ...
  */
  ...
  public List<@Valid Order> getContent() {
    return content;
  }

  public void setContent(List<@Valid Order> content) {
    this.content = content;
  }

  public OrderPage page(Integer page) {
    this.page = page;
    return this;
  }
  ...
  */
  ...
  public OrderPage size(Integer size) {
    this.size = size;
    return this;
  }
  ...
  */
  ...
  public OrderPage totalElements(Long totalElements) {
    this.totalElements = totalElements;
    return this;
  }
  ...
  */
  ...
  public OrderPage totalPages(Integer totalPages) {
    this.totalPages = totalPages;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.content, orderPage.content) &&
        ...
        Objects.equals(this.size, orderPage.size) &&
        Objects.equals(this.totalElements, orderPage.totalElements) &&
        Objects.equals(this.totalPages, orderPage.totalPages);
  }
